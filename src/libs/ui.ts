...
export const ui = {
	en: {
		...
		'work.lede':
			'{count} case studies explain the user problem, my role, the technical decisions, and what shipped.',
		...
		'work.allLede':
			'Browse {count} projects by platform and open any project for its scope, stack, constraints, and outcome.',
		'cat.web': 'Web',
		'cat.mobile': 'Mobile',
		'cat.ai': 'AI',
		...
		'blog.eyebrow': 'Blog',
		'blog.lede': 'Articles, resources, clips, walkthroughs, tools, and more.',
		'blog.soon': 'Coming soon',
		'blog.body': 'I am putting together something worth your time here.',
		// --- home page (added for the bilingual home) ---
		'nav.experience': 'Experience',
		'nav.contact': 'Contact',
		'nav.projects': 'Projects',
		'nav.menu': 'Menu',
		'nav.close': 'Close the menu',
		'nav.langAria': 'Switch the site language to Arabic',
		'hero.hi': "Hi. I'm",
		'hero.line2': 'A developer.',
		'featured.label': 'Featured project',
		'featured.lede':
			'Six builds, and the problem each one had to solve.',
		'exp.eyebrow': "Where I've Worked",
		'exp.lede': 'Teams, roles, and what shipped in each.',
		'exp.tabs': 'Employers',
		'edu.title': 'Education',
		'edu.lede': 'Where I studied.',
		'cert.title': 'Certifications',
		'cert.lede': 'Courses I finished and use.',
		'date.since': 'Since',
		'date.to': 'to',
		'about.lede':
			'Who I am, what I build, and the tools I keep coming back to.',
		'about.hobbies': 'Beyond the code',
		'about.hobbiesLede': 'What I do when I am not building something.',
		'about.mapAlt': 'Map of Amman, Jordan',
		'about.based': 'Based in Amman, Jordan',
		'contact.title': "Let's build something worth shipping",
		'contact.lede':
			'Send the scope and the deadline. I reply within two business days.',
		'contact.cta': 'Contact me',
		'contact.email': 'Email',
		'contact.phone': 'Phone',
		'footer.built': 'Built with Next.js, Tailwind CSS and Motion.',
		'footer.top': 'Back to top',
		'tape.performant': 'Performant',
		'tape.accessible': 'Accessible',
		'tape.secure': 'Secure',
		'tape.interactive': 'Interactive',
		'tape.scalable': 'Scalable',
		'tape.friendly': 'User friendly',
		'tape.responsive': 'Responsive',
		'tape.maintainable': 'Maintainable',
		'tape.seo': 'Search optimised',
		'tape.reliable': 'Reliable',
		'tape.bilingual': 'Bilingual',
		'tape.offline': 'Offline first',
	},
	ar: {
		...
		'work.lede':
			'تشرح {count} دراسات حالة مشكلة المستخدم ودوري والقرارات التقنية وما أُطلق فعليًا.',
		...
		'work.allLede':
			'تصفّح {count} مشروعًا بحسب المنصة، وافتح أي مشروع لمعرفة نطاقه وأدواته وقيوده ونتيجته.',
		'cat.web': 'الويب',
		'cat.mobile': 'الجوّال',
		...
		'cat.all': 'الكل',
		'work.empty': 'لا مشاريع في هذه الفئة.',
		'project.overview': 'نظرة عامة',
		'project.category': 'الفئة',
		'project.problem': 'المشكلة',
		'project.solution': 'الحل',
		'blog.eyebrow': 'المدونة',
		'blog.lede': 'مقالات ومصادر ومقاطع وشروحات وأدوات والمزيد.',
		'blog.soon': 'قريبًا',
		'blog.body': 'أعمل على إضافة محتوى يستحق وقتك هنا.',
		// --- الصفحة الرئيسية ---
		...
		'nav.langAria': 'Switch the site language to English',
		'hero.hi': 'مرحبًا، أنا',
		'hero.line2': 'مهندس برمجيات.',
		'featured.label': 'مشروع مختار',
		'featured.lede': 'ستة مشاريع، والمشكلة التي كان على كلٍّ منها حلّها.',
		'exp.eyebrow': 'أين عملت',
		'exp.lede': 'الفرق والأدوار وما أُطلق في كل منها.',
		'exp.tabs': 'جهات العمل',
		'edu.title': 'الدراسة',
		'edu.lede': 'أين درست.',
		'cert.title': 'الشهادات',
		'cert.lede': 'دورات أنهيتها وأستفيد منها.',
		'date.since': 'منذ',
		'date.to': 'إلى',
		'about.lede': 'من أنا، وما أبنيه، والأدوات التي أعود إليها دائمًا.',
		'about.hobbies': 'خارج الشيفرة',
		'about.hobbiesLede': 'ما أفعله حين لا أبني شيئًا.',
		'about.mapAlt': 'خريطة عمّان، الأردن',
		'about.based': 'مقيم في عمّان، الأردن',
		'contact.title': 'لنبنِ شيئًا يستحق الإطلاق',
		'contact.lede': 'أرسل النطاق والموعد النهائي، وأرد خلال يومي عمل.',
		'contact.cta': 'راسلني',
		'contact.email': 'البريد الإلكتروني',
		'contact.phone': 'الهاتف',
		'footer.built': 'مبني بـNext.js وTailwind CSS وMotion.',
		'footer.top': 'العودة إلى الأعلى',
		'tape.performant': 'سريع',
		'tape.accessible': 'سهل الوصول',
		'tape.secure': 'آمن',
		'tape.interactive': 'تفاعلي',
		'tape.scalable': 'قابل للتوسّع',
		'tape.friendly': 'سهل الاستخدام',
		'tape.responsive': 'متجاوب',
		'tape.maintainable': 'قابل للصيانة',
		'tape.seo': 'مهيّأ للبحث',
		'tape.reliable': 'موثوق',
		'tape.bilingual': 'ثنائي اللغة',
		'tape.offline': 'يعمل دون اتصال',
	},
} as const;
...
export const useT =
  (locale: Locale) =>
  (key: UIKey): string =>
    (ui[locale] as Record<string, string>)[key] ?? ui.en[key];
