  ...
  return (
    <div>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center">
        <h1 className="letter-animation text-[clamp(100px,25vw,200px)] leading-none text-emerald-500">
          404
        </h1>
        <h2 className="not-found-animation text-[clamp(30px,5vw,50px)] font-normal">
          Page Not Found
        </h2>
        <Link href="/">
