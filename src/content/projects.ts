...
export const projects: Project[] = [
	{
		...
		challenges: [
			{
				title: {
					en: 'One content model for many universities',
			...
			{
				title: {
					en: 'Moderating an open upload pipe',
	...
	},
	{
		...
		challenges: [
			...
			{
				title: {
					en: 'Calendar and notifications that respect the user',
					ar: 'تقويم وإشعارات تحترم المستخدم',
				},
				problem: {
			...
			{
				title: {
					en: 'Deep links that survive an install',
					ar: 'روابط عميقة تنجو من التثبيت',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'The pipeline does not port',
					ar: 'خط المعالجة غير قابل للنقل',
				},
				problem: {
			...
			{
				title: {
					en: 'Being honest about what it cannot do',
					ar: 'الصدق بشأن ما لا يستطيعه',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			...
			{
				title: {
					en: 'Three roles, one codebase',
					ar: 'ثلاثة أدوار وقاعدة شيفرة واحدة',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			...
			{
				title: {
					en: "Heavy imagery on a tourist's connection",
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'A translation model in a browser tab',
					ar: 'نموذج ترجمة داخل تبويب متصفح',
				},
				problem: {
			...
			{
				title: {
					en: 'Subtitles have to keep up with the video',
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'Removing music without removing singing',
			...
			{
				title: {
					en: 'An uncertain detection has to fail one way',
					ar: 'على الكشف غير المؤكد أن يفشل في اتجاه واحد',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'The platform caps you at three screenshots a second',
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'A timer does not know if you are there',
					ar: 'المؤقّت لا يعرف إن كنت موجودًا',
				},
				problem: {
			...
			{
				title: {
					en: 'Interrupting a presentation is unforgivable',
					ar: 'مقاطعة عرض تقديمي لا تُغتفر',
				},
				problem: {
			...
			{
				title: {
					en: 'Electron does not expose what is needed',
					ar: 'Electron لا يكشف ما يلزم',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'Hundreds of pins is not a map, it is noise',
					ar: 'مئات الدبابيس ليست خريطة بل ضجيج',
				},
				problem: {
			...
			{
				title: {
					en: 'People search for places by the wrong name',
					ar: 'يبحث الناس عن الأماكن بأسماء خاطئة',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'A complaint with no visible progress is a complaint nobody files twice',
					ar: 'شكوى بلا تقدّم مرئي شكوى لا تُقدَّم مرتين',
				},
				problem: {
			...
			{
				title: {
					en: 'Complaints arrive with photos on rural connections',
					ar: 'تصل الشكاوى بصور على اتصالات ريفية',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'One person, one vote, on a device you do not control',
					ar: 'شخص واحد وصوت واحد على جهاز لا تتحكم به',
				},
				problem: {
			...
			{
				title: {
					en: 'Everyone votes in the last hour',
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'Publishing a case exposes a family',
					ar: 'نشر حالة يكشف أسرة',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'The unfiltered original must never be written',
					ar: 'يجب ألا يُكتب الأصل غير المُرشَّح أبدًا',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: "'Free' is not the same as 'available'",
					ar: '«فارغ» ليس «متاح»',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'It gets opened on a phone, in a group chat, once',
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'The state machine is the safety mechanism',
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'The users are not developers',
					ar: 'المستخدمون ليسوا مطورين',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'A phone screen is not a terminal',
					ar: 'شاشة الهاتف ليست طرفية',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: "The inventory is other people's personal data",
					ar: 'البضاعة بيانات شخصية لأناس آخرين',
				},
				problem: {
	...
	},
	{
		...
		challenges: [
			{
				title: {
					en: 'Timed output is what makes a transcript searchable',
					ar: 'المخرج الموقوت هو ما يجعل التفريغ قابلًا للبحث',
				},
				problem: {
	...
	},
	{
		...
		tagline: {
			en: 'This site: a bilingual, content-first case-study portfolio.',
			ar: 'هذا الموقع: معرض أعمال ثنائي اللغة يقدّم دراسات حالة قبل كل شيء.',
		},
		summary: {
			en: 'A bilingual (English/Arabic) portfolio built as a content layer first and a design second: every project is written up once in both languages, then rendered as a card, a case study, and a search-engine record from the same source.',
			ar: 'معرض أعمال ثنائي اللغة (عربي/إنجليزي) بُني كطبقة محتوى أولًا وتصميم ثانيًا: كل مشروع يُكتب مرة واحدة بلغتين، ثم يُعرض بطاقةً ودراسةَ حالة وسجلًا لمحركات البحث من المصدر نفسه.',
		},
		category: 'web',
		status: 'live',
		featured: false,
		year: '2026',
		role: { en: 'Solo: content, design and engineering', ar: 'منفردًا: المحتوى والتصميم والبرمجة' },
		stack: [
			'Astro',
			'TypeScript',
			'React',
		...
		links: {
			live: 'https://portfolio.assoli.site',
			github: 'https://github.com/haithamassoli/portfolio',
		},
		overview: {
			en: [
			...
			ar: [
				'معظم معارض الأعمال تصميمٌ صُبَّ فيه بعض النص، ولهذا يستحيل ترجمتها وتتقادم لحظة إطلاق أي مشروع. عكستُ الترتيب: الموقع كله يقرأ من طبقة محتوى واحدة مُنمَّطة، كل نص فيها موجود بالعربية والإنجليزية، والصفحات مجرد عروض عليها.',
				'بهذا صارت اللغة الثانية مسألة عرض لا إعادة كتابة. سجل المشروع نفسه يُنتج البطاقة ودراسة الحالة ووسوم Open Graph ومدخل خريطة الموقع، في الاتجاهين، بلا نسخة مكرّرة تحتاج مزامنة.',
				'بُني بـ Astro ولا يشحن جافاسكربت تقريبًا، ويجلب أرقام GitHub وWakaTime الحيّة وقت البناء حتى لا تكون إحصاءات النشاط لقطة شاشة من السنة الماضية.',
			],
		},
		challenges: [
			{
				title: {
					en: 'Arabic that is typeset, not just translated',
					ar: 'عربية مركونة على الصفحة، لا مترجمة فحسب',
				},
				problem: {
					en: 'Flipping a layout to RTL with a direction attribute gets the columns right and everything else wrong: Latin stack names invert inside Arabic sentences, numeric axes read backwards, and a Latin display face applied to Arabic text looks like a fallback.',
					ar: 'قلب التخطيط إلى RTL بخاصية اتجاه يضبط الأعمدة ويُفسد ما عداها: أسماء التقنيات اللاتينية تنقلب داخل الجمل العربية، والمحاور الرقمية تُقرأ معكوسة، والخط اللاتيني على النص العربي يبدو كخط احتياطي.',
				},
				solution: {
					en: 'Arabic gets its own face, Thmanyah Sans, with the salt alternates enabled on headings. Logical CSS properties handle the mirroring, and the parts that must stay Latin, code identifiers, chart axes, URLs, are pinned to LTR inside an RTL page.',
					ar: 'للعربية خطها الخاص، ثمانية سانس، مع تفعيل بدائل salt في العناوين. وتتكفّل خصائص CSS المنطقية بالانعكاس، أما ما يجب أن يبقى لاتينيًا، كمعرّفات الشيفرة ومحاور الرسوم والروابط، فمثبّت على LTR داخل صفحة RTL.',
				},
			},
			{
				title: {
					en: 'Forty case studies without forty templates',
					ar: 'أربعون دراسة حالة بلا أربعين قالبًا',
				},
				problem: {
					en: 'Forty projects that each get a real write-up, in two languages, is 80 documents. Hand-authoring pages would guarantee that half of them drift out of date and the other half quietly lose a field.',
					ar: 'أربعون مشروعًا لكل منها كتابة حقيقية بلغتين تعني ثمانين مستندًا. وكتابة الصفحات يدويًا تضمن أن يتقادم نصفها ويفقد نصفها الآخر حقلًا دون أن ينتبه أحد.',
				},
				solution: {
					en: 'One TypeScript type describes a project, including the bilingual fields, so a missing Arabic paragraph is a compile error rather than a blank section in production. Every page is generated from that array.',
					ar: 'نوع TypeScript واحد يصف المشروع، بما فيه الحقول ثنائية اللغة، فتصير الفقرة العربية الناقصة خطأ في الترجمة البرمجية لا قسمًا فارغًا في الإنتاج. وكل صفحة تُولَّد من تلك المصفوفة.',
				},
			},
		],
		outcomes: {
			...
			ar: [
				'41 مشروعًا، لكل منها دراسة حالة كاملة باللغتين.',
				'مسارات عربية وإنجليزية كاملة، منعكسة حتى الخطوط والرسوم البيانية.',
				'نشاط GitHub وWakaTime حيّ، مع نسخة مجمّدة احتياطية حتى لا يُسقط انقطاعُ طرفٍ ثالث عمليةَ البناء.',
			],
		},
		sourced: true,
	},
